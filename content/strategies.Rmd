...
:::::: {.col-sm-10}
<h1 class='anchor'>Filter instructions</h1>
<h2 data-toc-skip>Filter instructions</h2>
...
generate_strategy_types <- function(category, strategy, illustration, illustration_position, description){
  ...
  cat(str_c('<div id="', clean_strategy, '" class="col-sm-6 col-md-4 col-lg-3 strategy-type ', clean_strategy, '" onclick="highlightStrategy', clean_strategy, '()" data-toggle="collapse" data-target=".multi-collapse-', clean_strategy, '">'))
  cat("<div class='card'>")
...
generate_highlight_functions <- function(strategy){
  ...
  glue::glue('
function highlightStrategy{{clean_strategy}}(){ 
$(".strategy-type.{{clean_strategy}}").toggleClass("highlight-this"); 
