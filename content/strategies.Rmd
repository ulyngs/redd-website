...
generate_strategy_tools <- function(devices, show_classes, title, illustration, description, link, link_text, link2, link2_text, price){
...
generate_strategy_types <- function(category, strategy, illustration, illustration_position, description){
  ...
  strategies_details %>% 
    ...
    distinct() %>% 
    ungroup() %>% 
    select(devices, show_classes, title, illustration, description, link, link_text, link2, link2_text, price) %>%
