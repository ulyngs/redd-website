...
generate_strategy_tools <- function(devices, show_classes, title, illustration, link, link_text, link2, link2_text, what_it_can_do, why_this, downside, price){
  ...
  cat('<div class="row">')
  cat('<div class="col-sm-2"><p class="what-it-can-do">Try it:</p></div>')
  cat(str_c('<div class="col-sm-5 text-center"><a target="_blank" href="', link, '" class="btn btn-primary tool-link" role="button">', link_text, '</a></div>'))
  if(!is.na(link2)){
    cat(str_c('<div class="col-sm-5 text-center"><a target="_blank" href="', link2, '" class="btn btn-primary tool-link" role="button">', link2_text, '</a></div>'))  
  }
  cat("</div>")
...
generate_strategy_types <- function(category, strategy, illustration, illustration_position, description){
  ...
  strategies_details %>% 
    ...
    distinct() %>% 
    ungroup() %>% 
    select(devices, show_classes, title, illustration, link, link_text, link2, link2_text, what_it_can_do, why_this, downside, price) %>%
